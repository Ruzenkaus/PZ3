...
using Microsoft.ML.Trainers;
    ...
    {
        public const string RetrainFilePath =  @"C:\Users\suvor\source\repos\yavpotoke\yavpotoke\DataLabels\yelp_labelled.txt";
        ...
        public static IEstimator<ITransformer> BuildPipeline(MLContext mlContext)
        {
            ...
            var pipeline = mlContext.Transforms.Text.FeaturizeText(inputColumnName:@"col0",outputColumnName:@"col0")      
                                    ...
                                    .Append(mlContext.MulticlassClassification.Trainers.LbfgsMaximumEntropy(new LbfgsMaximumEntropyMulticlassTrainer.Options(){L1Regularization=0.27436793F,L2Regularization=0.1451502F,LabelColumnName=@"col1",FeatureColumnName=@"Features"}))      
